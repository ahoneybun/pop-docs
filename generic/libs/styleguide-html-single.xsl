...
<!-- Customization layer for single-page html output 
     CREATION INFO:
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- Inline Formatting -->
	...
	<!-- This strippath template is copied from the 1.68.1 version of common.xls
			This template can be removed when version 1.68 of the Norman Walsh stylesheets
      are installed.
  -->
  ...
  <!-- The only change made to this template is the background-repeat 
       NOTE: this template is only used when draft.mode is 'yes'
   -->
